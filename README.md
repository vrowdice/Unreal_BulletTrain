...
Dragged into a war you don’t believe in, you’re forced to **defend a crumbling space station** — armed with nothing but a **rusted anti-aircraft gun**.

### 🧠 Themes Explored  
- **Forced Service** – You are a tool of the regime, not a soldier.  
...
- 🛰 **Immersive 3D Environments**  
  - Rail shooter combat across claustrophobic ships and ruined space docks.

- 📘 **Narrative-Driven Gameplay**  
  - Story unfolds through dialogue and environmental storytelling.

- 🎯 **Classic Rail Shooter Mechanics**  
  - Quick reflexes, precise aiming, and relentless waves of enemies.

- 💬 **Dynamic Dialogue System**  
  - CSV-based dialogues for modular story editing and emotionally charged interactions.
...
선택의 여지 없이, 무자비한 제국의 전쟁 도구로 전락한 당신은, 곧 **낡은 대공포** 하나만 들고 외딴 우주 정거장을 지켜야 합니다.

> ### 🧠 주요 테마  
- **강제 복무** – 국가의 병기가 되어버린 주인공의 내적 갈등  
...
## 🎮 주요 기능  
- 🛰 **몰입감 있는 3D 환경**  
  - **우주선 내부**, **폐허가 된 우주 정거장** 등 SF 배경의 레일 슈터 전투  

- 📘 **서사 중심 게임플레이**  
  - **대사**, **환경 요소**를 통해 점진적으로 전개되는 스토리  

- 🎯 **클래식 레일 슈터 메커니즘**  
  - 정확한 조준과 빠른 반응이 요구되는 고속 전투  

- 💬 **CSV 기반 대화 시스템**  
  - **모듈화된 스토리 편집**과 **감정 중심 대사 구성**을 위한 맞춤형 시스템  
